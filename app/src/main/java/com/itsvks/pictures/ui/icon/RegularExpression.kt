package com.itsvks.pictures.ui.icon
...
public val Icons.RegularExpression: ImageVector
  get() {
    ...
    _regularExpression = Builder(
      name = "RegularExpression", defaultWidth = 48.0.dp,
      defaultHeight = 48.0.dp, viewportWidth = 48.0f, viewportHeight = 48.0f
    ).apply {
      group {
        path(
          fill = SolidColor(Color(0xFFD0BCFF)), stroke = null, strokeLineWidth = 0.0f,
